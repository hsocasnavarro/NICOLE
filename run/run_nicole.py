        ...
        for line in source_lines:
            ...
            if l != '':
                try:
                    ...
                    badlines.append('Error in file '+filestocheck[ifile]+'. Offending line ['+str(indline)+']:'+line)
                    errors=1
#        if errors == 0:
...
#    ncycles=get_value(config,'Cycles','1','NICOLE.input')
    ...
    elif abund_set == 'grevesse_sauval_1998':
...
# Write __input.dat file for NICOLE
    ...
    f.write(speed+'     ! speed \n')
    f.write(always_compute_der+'     ! always_compute_der \n')
    ...
    for iregion in range(int(nregions)):
        ...
        tmp5=get_value(config,'Layer','1','NICOLE.input'
                      ,'Region '+str(iregion+1))
        f.write(tmp1+' '+tmp2+' '+tmp3+' '+tmp4+' '+tmp5+'\n')
